...
public class FakeUserRepository {
	...
	static {
		User u = new User("John", "Doe", LocalDate.of(1993, 10, 10), "jdoe@dawan.com", new BCryptPasswordEncoder().encode( "azerty"));
		u.setId(1L);
		dataDb.put(1L, u);
		u = new User("Jo", "Dalton", LocalDate.of(1988, 9, 1), "jdalton@dawan.com", new BCryptPasswordEncoder().encode( "azerty"));
		u.setId(2L);
		dataDb.put(2L, u);
		u = new User("Yves", "Roulo", LocalDate.of(1965, 3, 4), "yroulo@dawan.com", new BCryptPasswordEncoder().encode( "azerty"));
		u.setId(3L);
		dataDb.put(3L, u);
	}
